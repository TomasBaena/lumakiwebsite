<?php
	...
	if (isset($_POST["submit"])) {
		...
		$body ="From: $name\n\nE-Mail: $email\n\nMessage: $message";
		$return = "Hello $name,\n\nThank you reaching out to us!\n\nYour message was: '$message'\n\nWe will get back to you shorty and talk about your great ideas, have a great day!\n\nLumaki Team";
...
<html>
	<head>
		...
		<title>Let's Get Started | Lumaki</title>
	</head>
	<body>
		<div class="header">
		...
		<div class="contact-body topShadow">
			<div class="row alignMiddle">
				...
				<form class="form-horizontal" role="form" method="post" action="getstarted.php">
